...
export const FIELD_LABELS: FieldLabel[] = [
  ...
  { key: "occupation", type: "text", baseConfidence: 0.75, labels: ["occupation", "profession", "job", "designation", "employment", "working as", "profession details"], tamilLabels: ["தொழில்", "தொழில் விவரம்"] },
  { key: "annualIncome", type: "text", baseConfidence: 0.70, labels: ["income", "annual income", "salary", "annual salary", "monthly income", "income per annum"], tamilLabels: ["வருமானம்", "ஆண்டு வருமானம்"] },
  ...
  { key: "phone", type: "phone", baseConfidence: 0.85, labels: ["phone", "mobile", "contact", "phone no", "mobile no", "contact number", "phone number", "mobile number", "whatsapp"], tamilLabels: ["தொலைபேசி", "அலைபேசி", "தொடர்பு எண்"] },
