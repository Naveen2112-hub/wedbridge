...
export function GlassCard({ children, className }: { children: ReactNode; className?: string }) { return <div className={cn("glass-card p-8 sm:p-10", className)}>{children}</div>; }
      ...
      <div className="container-page flex min-h-[calc(100vh-4rem)] items-center justify-center py-16">
        <div className="grid w-full max-w-5xl items-center gap-12 lg:grid-cols-2">
          <div className="relative hidden aspect-[4/5] overflow-hidden rounded-3xl shadow-card lg:block">
            ...
            <div className="absolute bottom-8 left-8 right-8 text-white"><p className="font-display text-2xl font-semibold">Begin your journey with WedBridge</p><p className="mt-2 text-sm text-white/80">Premium matrimony, rooted in South Indian tradition.</p></div>
          </div>
