  ...
  return (
    <ToastContext.Provider value={{ toast, dismiss }}>
      ...
      <div className="pointer-events-none fixed bottom-4 right-4 z-[200] flex flex-col gap-2 sm:bottom-6 sm:right-6" role="region" aria-label="Notifications" aria-live="polite">
        {toasts.map((t) => (
          <div key={t.id} className={cn("pointer-events-auto flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium shadow-lg ring-1 animate-in slide-in-from-bottom-2", t.type === "success" && "bg-green-600 text-white ring-green-700", t.type === "error" && "bg-red-600 text-white ring-red-700", t.type === "info" && "bg-primary-700 text-white ring-primary-800", t.type === "loading" && "bg-white text-ink ring-primary-200")}>
