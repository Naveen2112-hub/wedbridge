    ...
    return (
      <div className="flex min-h-[60vh] items-center justify-center bg-grain">
        <div className="mx-auto max-w-md px-6 text-center">
          <span className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-accent-100 text-accent-700"><ShieldAlert className="h-7 w-7" /></span>
          <h1 className="heading-md mt-5">{t("auth.admin.notAuthorized")}</h1>
          <p className="text-lead mt-2">Redirecting to admin login…</p>
        </div>
      </div>
    );
  }
