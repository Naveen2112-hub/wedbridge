...
const sections = [
  ...
  { title: "4. Profile Visibility", body: "Your profile is visible to other registered users based on your privacy settings. You can control who sees your contact information through your contact visibility settings (everyone, after accept, after booking, or premium only)." },
