...
import { Bell, Send, Users, Crown, User, Store, Loader as Loader2, CircleCheck as CheckCircle2 } from "lucide-react";
    ...
    <div>
      ...
      <div className="max-w-2xl rounded-2xl bg-white p-6 shadow-sm ring-1 ring-primary-100">
        ...
        <div className="mt-4 space-y-4">
          ...
          <div><label className="label">Message</label><textarea className="input" rows={4} value={message} onChange={(e) => setMessage(e.target.value)} placeholder="Type your message…" /></div>
