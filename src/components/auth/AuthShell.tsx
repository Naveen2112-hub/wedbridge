...
export function GlassCard({ children, className }: { children: ReactNode; className?: string }) { return <div className={cn("card p-8 sm:p-10", className)}>{children}</div>; }
export function AuthShell({ children }: { children: ReactNode }) {
  return (
    <div className="relative overflow-hidden bg-gradient-soft">
      <div className="container-page flex min-h-[calc(100vh-4rem)] items-center justify-center py-16">
        <div className="grid w-full max-w-5xl items-center gap-12 lg:grid-cols-2">
          <div className="relative hidden aspect-[4/5] overflow-hidden rounded-3xl shadow-elevated lg:block">
