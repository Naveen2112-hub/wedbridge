...
export function RefundClient() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      <Reveal><h1 className="text-4xl font-bold tracking-tight text-neutral-900">Refund Policy</h1><p className="mt-2 text-sm text-neutral-500">Last updated: January 2025</p></Reveal>
