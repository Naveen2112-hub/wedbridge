...
export default function ExportPage() {
  ...
  const handleExport = async (type: "users" | "vendors", format: ExportFormat) => {
    ...
    setExporting(key);
    try {
      if (type === "users") await exportUsers(format); else await exportVendors(format);
