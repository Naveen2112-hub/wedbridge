...
export default function RegisterPage() {
  ...
  const onSubmit = async (values: RegisterValues) => {
    setAuthError(null);
    try { await registerWithEmail(values.name, values.email, values.password); router.push("/complete-profile"); }
  ...
  const onGoogle = async () => {
    ...
    try { await loginWithGoogle(); router.push("/complete-profile"); }
      ...
      <GlassCard>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <div className="relative"><User className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted" /><input id="name" type="text" autoComplete="name" className="auth-input pl-10" {...register("name")} /></div>
          ...
          <div>
            ...
            <div className="relative"><Lock className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted" /><input id="password" type="password" autoComplete="new-password" className="auth-input pl-10" {...register("password")} /></div>
          ...
          <div>
            ...
            <div className="relative"><Lock className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted" /><input id="confirm" type="password" autoComplete="new-password" className="auth-input pl-10" {...register("confirm")} /></div>
