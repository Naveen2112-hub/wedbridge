        ...
        <div className="relative overflow-hidden rounded-3xl bg-primary px-6 py-12 text-center text-white shadow-card sm:px-12 sm:py-16">
          ...
          <div className="relative">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              <Link href="#" className="btn bg-white text-primary-900 hover:bg-white/90"><Apple className="h-5 w-5" />{t("home.download.appStore")}</Link>
              <Link href="#" className="btn border border-white/40 bg-white/10 text-white hover:bg-white/20"><Play className="h-5 w-5" />{t("home.download.googlePlay")}</Link>
            </div>
          </div>
        </div>
      </Reveal>
