      ...
      <div className="w-full max-w-md">
        <div className="card p-8 sm:p-10">
          <div className="text-center">
            <span className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-primary-900 text-white shadow-elevated">
          ...
          <p className="mt-6 text-center text-sm text-muted"><Link href="/" className="font-semibold text-primary-600 hover:underline">Back to Home</Link></p>
        </div>
      </div>
    </div>
  );
